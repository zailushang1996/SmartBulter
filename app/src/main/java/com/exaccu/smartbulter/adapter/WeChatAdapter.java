package com.exaccu.smartbulter.adapter;
...
/**
 * Author:liuzhixiang
 * PackageName:com.exaccu.smartbulter.adapter
 * Create by 17864 on 2018/8/26
 *
 * @ Description:
 */
public class WeChatAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(!TextUtils.isEmpty(data.getImgUrl())){
            ...
            PicassoUtils.loadImageViewSize(mContext, data.getImgUrl(), 200, 250, viewHolder.iv_img);
        }
        return convertView;
    }
